...
var custom = {
  ...
  adjustHeaderHeight: function adjustHeaderHeight() {
    var MIN_HEIGHT = 750;
  ...
  navBackground: function navBackground() {
    ...
    $(window).on('scroll', function () {
      ...
      var isScrolled = $(this).scrollTop() > threshold;
    ...
    if (!custom.trigger) {
      ...
      skillProgress.on('enter', function () {
        progressBars.each(function (index, progressBar) {
          ...
          var percent = $progressBar.parent().data('progress-percent') / 100;
          var progressTotal = percent * $progressBar.width();
  ...
  linkHighlight: function linkHighlight() {
    ...
    sections.each(function () {
      ...
      var triggerID = '#' + section.attr('id');
      // get the height of the section plus some extra padding
      var elementHeight = section.outerHeight() + 40;
      ...
      .on('enter leave', function (event) {
        ...
        var link = nav.find('a[href="#' + sectionID + '"]');
  ...
  copyrightYear: function copyrightYear() {
    ...
    var footerText = footer.querySelector('h6');
